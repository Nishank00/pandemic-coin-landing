...
export default function Contact() {
    ...
    return (
      <div className="bg-pdc-d-gray h-fit w-[100%] flex md:pt-[10px] pt-0 flex-col md:flex-row">
        <div class="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-bg-pdc-d-gray text-gray-100 rounded-lg shadow-lg">
