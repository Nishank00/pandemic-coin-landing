...
const Advisor = ({ title }) => (
    // <div className="w-full shadow-md px-2 py-4 b1">
        <div  data-aos="fade-in" className="h-[111px] border-[0.75px] border-[solid] border-[#342CB2] border-opacity-80 relative flex items-center justify-center overflow-hidden bg-pdc-d-gray/30  px-12 py-8 rounded-lg">
