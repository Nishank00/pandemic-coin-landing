    ...
    const features = [
        {
            ...
            description: 'The concept of underground Community Shelters serves as a safety net against potential conflicts or geopolitical escalations worldwide. ',
            imageUrl: feature1,
        ...
        },
        {
            ...
            description: 'The platform operates on a secure and transparent blockchain network, ensuring the integrity and immutability of transactions.',
            imageUrl: feature2,
        ...
        },
        {
            ...
            description: 'Pandemic Coin enables users to trade their Pandemic Coins on various cryptocurrency exchanges, offering liquidity and trading opportunities. ',
            imageUrl: feature3,
            backgroundColor: 'bg-[#3A3A3A]',
            color: 'text-[#342CB2]'
        },
        {
            ...
            description: 'The Pandemic Coin ecosystem is augmented with the PEN (Pandemic Emergency Network) app, connecting individuals directly to the platform. ',
            imageUrl: feature4,
            backgroundColor: 'bg-gradient-to-b from-[#140E7B17] to-[#140E7B17]',
            color: 'text-[#342CB2]',
        },
