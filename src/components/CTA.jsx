...
const CTA = () => {
    return (
        <section className="text-gray-900 overflow-hidden relative body-font">
            <div className="container px-4 md:mx-auto mb-10 mt-8">
                <div className="w-full md:w-3/4 px-4 md:px-20 overflow-hidden relative rounded-3xl py-24 bg-white flex flex-col items-center mx-auto">
