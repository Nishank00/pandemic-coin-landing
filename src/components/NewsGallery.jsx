...
const NewCard = ({ imageUrl, description }) => (
    <div className="p-4 rounded-lg relative bg-transparent">
        <div className="h-full mx-auto overflow-hidden rounded-[20px] max-h-[400px] md:max-h-[500px] md:rounded-t-[20px]">
            <Image width={720} height={600} className="h-[400px] md:h-[300px] w-full object-cover object-center" src={imageUrl} alt="blog" />
